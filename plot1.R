...
##create histogram on current device
with(filtered_household_power, hist(Global_active_power/500, col = "red", xlim = c(0,6), main = "Global Active Power", xlab = "Global Active Power (kilowatts)"))
